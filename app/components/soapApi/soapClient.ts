...
export const SOAPClientParameters = <any>function()
{
    var _pl = new Array();
    var _sl = new Array();
...
export const SOAPClient = <any>function SOAPClient() {}
...
// private: wsdl cache
const SOAPClient_cacheWsdl = new Array();
...
SOAPClient._onSendSoapRequest = function(method, async, callback, wsdl, req)
{
    ...
    if(nd.length == 0)
    {
        ...
        {
            if(async || callback)
                o = new (<any>Error)(500, req.responseXML.getElementsByTagName("faultstring")[0].childNodes[0].nodeValue);
            else
                throw new (<any>Error)(500, req.responseXML.getElementsByTagName("faultstring")[0].childNodes[0].nodeValue);
        }
    }
    else
